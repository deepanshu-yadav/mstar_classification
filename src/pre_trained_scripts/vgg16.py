...
class Vgg16():
    ...
    def __init__(self):
        ...
        self.FILe_PATH = os.path.join(os.getcwd() , 'pre_trained_models')
        self.create()
        self.get_classes()
    ...
    def get_classes(self):
        ...
        #fpath = get_file(fname, os.path.join(self.FILe_PATH , fname  ), cache_subdir='models')
    ...
    def create(self):
        ...
        fname = 'vgg16.h5'
        model.load_weights(os.path.join(self.FILe_PATH , fname  ))
        #model.load_weights(os.path.join(self.FILE_PATH , fname))
